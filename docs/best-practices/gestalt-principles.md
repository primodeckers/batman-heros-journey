...
categoria. Se uma cor representa "região Norte" em um gráfico, ela deve
representar "região Norte" em **todos** os gráficos do dashboard —
consistência de mapeamento cor→categoria é obrigatória (é literalmente um
dos critérios de avaliação: "aplicação consistente").
