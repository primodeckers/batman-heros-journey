...
| Anthropic Economic Index | [huggingface.co/datasets/Anthropic/EconomicIndex](https://huggingface.co/datasets/Anthropic/EconomicIndex) (release `2025_09_15`, arquivo `aei_enriched_claude_ai_*.csv`, 26,8 MB — filtrado pra facet `country`) | Uso do Claude por país: 173 países com uso > 0, 3 métricas cada (uso per capita normalizado, % do uso mundial, PIB por pessoa em idade ativa) | 31/07/2026 | `public/data/anthropic-claude-usage-by-country.csv` |
| world-atlas (Natural Earth, via CDN jsDelivr) | [github.com/topojson/world-atlas](https://github.com/topojson/world-atlas) (`countries-110m.json`) | Contorno dos países pro mapa-múndi interativo — não é dado da narrativa em si, é o mapa-base | 31/07/2026 | `public/data/world-countries-110m.json` |
